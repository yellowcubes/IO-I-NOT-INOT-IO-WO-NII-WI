...
const Phrases = ["Ceci est un outil qui permet de créer une infinité du même mème. Créons-en un ensemble!",
"bon travail ! tu veux réessayer ?","cool et bien. tu penses que tu peux faire mieux ?",
"cool et bien. faire mieux tu tu que penses peux ?","tu peux cool faire et good. tu es mieux ? pense faire"
,"et peut penser cool vous bien. mieux ? faire faire vous","faire bien. penser et vous pouvez cool vous faire mieux ?",
...
"cool mieux ? et bon. peut penser vous faites vous faites vous"," faire mieux ? faire vous cool pensez vous pouvez et bon.",
...
const Colors = ["#474a50","#4b84f7","#2ab841","#b82a7d","#e45d10",
"#003170","#ff2a4d","#98ffc6","#091444","#edff9f"]
function randomNumberInRange(min, max) {
  ...
  return (
    <>
      ...
      <section style={{backgroundColor: countColorsHeaderBG === 0 ? "#ffffff" : Colors[countColorsHeaderBG] }}>
      <div className="section1" >
        <div className="textbox" style={{backgroundColor: countColorsHeaderBG === 0 ? "#ffffff" : Colors[countColorsHeaderBox] }}>

        <span style={{color: countColorsHeaderText === 0 ? "#000000" : Colors[countColorsHeaderText] }}>
       {HeaderText}
       </span>

        </div>
        
        <button style={{backgroundColor: countColorsHeaderText === 0 ? "#474a50" : Colors[countColors] }} onClick={() => setShowInput(!showInput)}>
          Créons un mème 
        </button>
        {showInput && (
          <div className="inputContainer">
            ...
            <button style={{backgroundColor: countColorsHeaderText === 0 ? "#474a50" : Colors[countColors] , padding: "5px 15px", maxWidth: "100px",width: "100%", alignSelf:"center" }} onClick={addCard}>GO!</button>
          </div>
        )}
      {    latestMeme !== "" &&   <h2>Ton mèmes:</h2>}
        {    latestMeme !== "" && 
        <Card text={latestMeme}></Card>
        }
      ...
      <div className="textbox textbox2">
        <span>ou regardez ce que d'autres ont fait.</span>
        </div>
  
     <div className="cards_container" style={{transform: cards.length > 20 ?  "scale(60%) translateY(-30%)" : "" , gridTemplateColumns: cards.length > 20 ?  "repeat(6,1fr)" : ""  }}>
          {cards.map((card, i) => {
